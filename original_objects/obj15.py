...
box5 = box(pos=vector(1,3,0), size=box_size)
box6 = box(pos=vector(1,3,1), size=box_size)
obj15 = compound([box0,box1,box2,box3,box4,box5,box6], pos = vector(0,0,0))

obj15.rotate(angle, axis= rotation, origin= vector(0,0,0))

scene.capture("sample15_"+str(angle))