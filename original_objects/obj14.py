...
box1 = box(pos=vec(0,1,0), size=box_size)
box2 = box(pos=vector(0,2,0), size=box_size)
box3 = box(pos=vector(0,3,0), size=box_size)
box4 = box(pos=vector(0,3,1), size=box_size)
box5 = box(pos=vector(1,0,0), size=box_size)
box6 = box(pos=vector(2,0,0), size=box_size)
box7 = box(pos=vector(2,0,1), size= box_size)
obj14 = compound([box0,box1,box2,box3,box4,box5,box6,box7], pos = vector(0,0,0))

obj14.rotate(angle, axis= rotation, origin= vector(0,0,0))

scene.capture("sample14_"+str(angle))