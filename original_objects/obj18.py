...
box2 = box(pos=vector(-1,1,0), size=box_size)
box3 = box(pos=vector(-1,2,0), size=box_size)
box4 = box(pos=vector(-1,3,0), size=box_size)
box5 = box(pos=vector(-1,3,1), size=box_size)
box6 = box(pos=vector(1,0,0), size=box_size)
box7 = box(pos=vector(1,-1,0), size= box_size)
box8 = box(pos=vector(1,-2,0), size= box_size)
obj18 = compound([box0,box1,box2,box3,box4,box5,box6,box7,box8], pos = vector(0,0,0))

obj18.rotate(angle, axis= rotation, origin= vector(0,0,0))

scene.capture("sample18_"+str(angle))
